...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Feb 25, 2025 at 11:23 AM
...
CREATE TABLE IF NOT EXISTS `student` (
  ...
  `profile_photo_path` varchar(255) DEFAULT 'no.jpg',
...
INSERT INTO `student` (`student_id`, `enrollment_number`, `student_name`, `email`, `phone_number`, `student_password`, `profile_photo_path`) VALUES
(1, 20215504, 'Aarti Sharma', 'aarti.sharma@example.com', '9876543210', 'password12', 'images/1.jpg'),
(2, 20215505, 'Neha Patel', 'neha.patel@example.com', '9823456789', 'securepass', 'images/2.jpg'),
(3, 20215507, 'Pooja Mehta', 'pooja.mehta@example.com', '9898765432', 'mypassword', 'images/3.jpg'),
(12, 201625, 'Ravina', 'ravina@gmail.com', '8401495064', '12345678', 'images/no.png'),
(11, 202415, 'Fahad Vahora', 'fahadvohra143@gmail.com', '8401495064', '123456', 'images/no.png');
...
CREATE TABLE IF NOT EXISTS `students_status` (
  ...
  `continue_assessment` int NOT NULL,
  `attendance` int NOT NULL,
  `fees` int NOT NULL,
  `internal_exam` int NOT NULL
...
INSERT INTO `students_status` (`student_id`, `continue_assessment`, `attendance`, `fees`, `internal_exam`) VALUES
(1, 1, 1, 1, 1),
(2, 1, 1, 1, 1),
(3, 0, 0, 1, 1),
(11, 0, 0, 0, 0),
