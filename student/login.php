...
<head>
    ...
    <title>Student Login / Signup Box</title>
                                    ...
                                    <div class="card-back">
                                        <div class="center-wrap">
                                            ...
                                            <form action="insert_student.php" method="POST">
                                                <div class="form-group">
                                                    <input type="text" name="enrollment_number" class="form-style" placeholder="Your Enrollment Number" autocomplete="off">
                                                    <i class="input-icon material-icons">numbers</i>
                                                </div>
                                                <div class="form-group">
                                                    <input type="text" name="name" class="form-style" placeholder="Your Name" autocomplete="off">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" name="mobile_number" class="form-style" placeholder="Your Mobile Number" autocomplete="off">
